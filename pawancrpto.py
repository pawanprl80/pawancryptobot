...
# --- 1. SAFE IMPORT HANDLER (Prevents Crash if libraries are still installing) ---
try:
    import pandas_ta as ta
except ImportError:
    st.error("Engine components (pandas-ta) are still loading. Please refresh this page in 30 seconds.")
    st.stop()
...
class MasterAlgoScanner:
    ...
    def get_audit(self, symbol):
        ...
        try:
            ...
            # --- PRECIOUS 7-POINT FORMULA (2026 EDITION) ---
